...
public class SwitchInstruction extends Instruction {
  ...
  public SwitchInstruction(int opcode, int group, boolean wide, int bytecodeVersion,int offset, int[] operands) {
    super(opcode, group, wide, bytecodeVersion, offset,operands);
  }
