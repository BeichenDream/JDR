...
public class BytecodeSourceMapper {
  ...
  public void addMapping(String className, String methodName, int bytecodeOffset, int sourceLine) {
    ...
    Map<Integer, Integer> method_mapping = class_mapping.computeIfAbsent(methodName, k -> new LinkedHashMap<>());
  ...
  public Map<String, Map<String, Map<Integer, Integer>>> getMapping() {
    return mapping;
  }
}