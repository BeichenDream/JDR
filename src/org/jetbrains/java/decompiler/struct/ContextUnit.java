...
public class ContextUnit {
  ...
  public static Map<String, Map<String, Map<Integer, Integer>>> ClassesLineNumbers = new LinkedHashMap<>();
      ...
      case TYPE_JAR, TYPE_ZIP -> {
        ...
        for (int i = 0; i < classes.size(); i++) {
          ...
          if (entryName != null) {
            ...
            ClassesLineNumbers.putAll(DecompilerContext.getBytecodeSourceMapper().getMapping());
